 ...
 */
interface VectorMappingSynchronizer {
     ...
     * @param progress optional per-element progress (after [ValueMappingService] calls [ValueMappingSyncProgressCallback.onBegin]).
     */
    fun sync(
        attributeUrn: String,
