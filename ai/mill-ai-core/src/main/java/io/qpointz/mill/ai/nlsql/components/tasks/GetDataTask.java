...
//@AllArgsConstructor
//@Builder
//public class GetDataTask extends AbstractSchemaTask {
//
//
//    public record GetDataResponse(String sql, String queryName, String explanation, String language) {}
//
//    @Getter
...
//        return compositeItem(staticTemplate("prompts/main-chart-data-user.prompt",
