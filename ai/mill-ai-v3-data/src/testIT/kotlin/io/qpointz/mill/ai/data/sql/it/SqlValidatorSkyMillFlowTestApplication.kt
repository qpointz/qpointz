...
/**
 * Minimal Spring context for Skymill + flow backend SQL validator IT (mirrors
 * [io.qpointz.mill.data.backend.flow.FlowFacetMetadataTestApplication]).
 */
...
open class SqlValidatorSkyMillFlowTestApplication {
