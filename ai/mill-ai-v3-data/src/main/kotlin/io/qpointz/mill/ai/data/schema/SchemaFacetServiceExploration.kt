...
/**
 * [SchemaExplorationPort] backed by Mill Data [SchemaFacetService] (former [SchemaToolHandlers] logic).
 */
class SchemaFacetServiceExploration(
    private val svc: SchemaFacetService,
) : SchemaExplorationPort {
...
/**
 * Adapts this [SchemaFacetService] to [SchemaExplorationPort] for non-Spring call sites (CLI, tests).
 */
fun SchemaFacetService.asSchemaExplorationPort(): SchemaExplorationPort = SchemaFacetServiceExploration(this)
