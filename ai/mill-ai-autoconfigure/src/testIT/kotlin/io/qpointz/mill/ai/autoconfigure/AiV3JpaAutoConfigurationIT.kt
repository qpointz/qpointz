...
/**
 * Validates that AiV3AutoConfiguration registers JPA-backed ai/v3 stores when
 * mill-ai-persistence is on the classpath and a JPA/Flyway stack is available.
 *
