# mill-ai-autoconfigure

**Assembly / starter module for Boot hosts:** declare **`implementation(project(":ai:mill-ai-autoconfigure"))`** (or the Mill `ai-chat-service` feature) and you get **`mill-ai-service`** (REST + SSE + OpenAPI) transitively, plus the auto-configurations below.
