...
/**
 * AI-owned port for schema exploration tools (`list_schemas`, `list_tables`, `list_columns`,
 ...
 */
interface SchemaExplorationPort {
...
/**
 * A single schema entry returned by [SchemaExplorationPort.listSchemas].
 *
...
/**
 * A single table entry returned by [SchemaExplorationPort.listTables].
 */
...
/**
 * A single column entry returned by [SchemaExplorationPort.listColumns].
 */
...
/**
 * A single relation entry returned by [SchemaExplorationPort.listRelations].
 */
...
/**
 * Filter direction for [SchemaExplorationPort.listRelations].
 */
