...
mill {
    description = "Mill AI — HTTP/SSE service facade (REST controllers, OpenAPI docs)"
    ...
    suites {
        register<JvmTestSuite>("testIT") {
            dependencies {
                ...
                runtimeOnly(project(":ai:mill-ai-persistence"))
            }
        }
        ...
        configureEach {
            if (this is JvmTestSuite) {
                ...
                dependencies {
                    ...
                    implementation(libs.boot.starter.webflux)
                    implementation(libs.boot.starter.webflux.test)
