...
class FunctionSignature(_message.Message):
    ...
    class FinalArgVariadic(_message.Message):
        __slots__ = ("min_args", "max_args", "consistency")
    ...
    class Scalar(_message.Message):
        __slots__ = ("arguments", "name", "description", "deterministic", "session_dependent", "output_type", "variadic", "normal", "implementations")
        ...
        def __init__(self, arguments: _Optional[_Iterable[_Union[FunctionSignature.Argument, _Mapping]]] = ..., name: _Optional[_Iterable[str]] = ..., description: _Optional[_Union[FunctionSignature.Description, _Mapping]] = ..., deterministic: bool = ..., session_dependent: bool = ..., output_type: _Optional[_Union[_type_expressions_pb2.DerivationExpression, _Mapping]] = ..., variadic: _Optional[_Union[FunctionSignature.FinalArgVariadic, _Mapping]] = ..., normal: _Optional[_Union[FunctionSignature.FinalArgNormal, _Mapping]] = ..., implementations: _Optional[_Iterable[_Union[FunctionSignature.Implementation, _Mapping]]] = ...) -> None: ...
    class Aggregate(_message.Message):
        __slots__ = ("arguments", "name", "description", "deterministic", "session_dependent", "output_type", "variadic", "normal", "ordered", "max_set", "intermediate_type", "implementations")
        ARGUMENTS_FIELD_NUMBER: _ClassVar[int]
        NAME_FIELD_NUMBER: _ClassVar[int]
        DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
        DETERMINISTIC_FIELD_NUMBER: _ClassVar[int]
        ...
        implementations: _containers.RepeatedCompositeFieldContainer[FunctionSignature.Implementation]
        def __init__(self, arguments: _Optional[_Iterable[_Union[FunctionSignature.Argument, _Mapping]]] = ..., name: _Optional[str] = ..., description: _Optional[_Union[FunctionSignature.Description, _Mapping]] = ..., deterministic: bool = ..., session_dependent: bool = ..., output_type: _Optional[_Union[_type_expressions_pb2.DerivationExpression, _Mapping]] = ..., variadic: _Optional[_Union[FunctionSignature.FinalArgVariadic, _Mapping]] = ..., normal: _Optional[_Union[FunctionSignature.FinalArgNormal, _Mapping]] = ..., ordered: bool = ..., max_set: _Optional[int] = ..., intermediate_type: _Optional[_Union[_type_pb2.Type, _Mapping]] = ..., implementations: _Optional[_Iterable[_Union[FunctionSignature.Implementation, _Mapping]]] = ...) -> None: ...
    class Window(_message.Message):
        __slots__ = ("arguments", "name", "description", "deterministic", "session_dependent", "intermediate_type", "output_type", "variadic", "normal", "ordered", "max_set", "window_type", "implementations")
        ...
        implementations: _containers.RepeatedCompositeFieldContainer[FunctionSignature.Implementation]
        def __init__(self, arguments: _Optional[_Iterable[_Union[FunctionSignature.Argument, _Mapping]]] = ..., name: _Optional[_Iterable[str]] = ..., description: _Optional[_Union[FunctionSignature.Description, _Mapping]] = ..., deterministic: bool = ..., session_dependent: bool = ..., intermediate_type: _Optional[_Union[_type_expressions_pb2.DerivationExpression, _Mapping]] = ..., output_type: _Optional[_Union[_type_expressions_pb2.DerivationExpression, _Mapping]] = ..., variadic: _Optional[_Union[FunctionSignature.FinalArgVariadic, _Mapping]] = ..., normal: _Optional[_Union[FunctionSignature.FinalArgNormal, _Mapping]] = ..., ordered: bool = ..., max_set: _Optional[int] = ..., window_type: _Optional[_Union[FunctionSignature.Window.WindowType, str]] = ..., implementations: _Optional[_Iterable[_Union[FunctionSignature.Implementation, _Mapping]]] = ...) -> None: ...
    ...
    class Argument(_message.Message):
        __slots__ = ("name", "value", "type", "enum")
        class ValueArgument(_message.Message):
            __slots__ = ("type", "constant")
            TYPE_FIELD_NUMBER: _ClassVar[int]
            CONSTANT_FIELD_NUMBER: _ClassVar[int]
            type: _parameterized_types_pb2.ParameterizedType
            constant: bool
            def __init__(self, type: _Optional[_Union[_parameterized_types_pb2.ParameterizedType, _Mapping]] = ..., constant: bool = ...) -> None: ...
        ...
        class EnumArgument(_message.Message):
            ...
            optional: bool
            def __init__(self, options: _Optional[_Iterable[str]] = ..., optional: bool = ...) -> None: ...
        NAME_FIELD_NUMBER: _ClassVar[int]
