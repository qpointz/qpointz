...
class ParameterizedType(_message.Message):
    __slots__ = ("bool", "i8", "i16", "i32", "i64", "fp32", "fp64", "string", "binary", "timestamp", "date", "time", "interval_year", "interval_day", "interval_compound", "timestamp_tz", "uuid", "fixed_char", "varchar", "fixed_binary", "decimal", "precision_time", "precision_timestamp", "precision_timestamp_tz", "struct", "list", "map", "user_defined", "user_defined_pointer", "type_parameter")
    ...
    class IntegerParameter(_message.Message):
        __slots__ = ("name", "range_start_inclusive", "range_end_exclusive")
        NAME_FIELD_NUMBER: _ClassVar[int]
