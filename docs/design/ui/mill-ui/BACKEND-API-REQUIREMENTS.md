...
5. [Domain: Analysis](#domain-analysis)
...
deprecation). See [INLINE-CHAT-FOUNDATION.md](INLINE-CHAT-FOUNDATION.md) and
[v3-chat-service.md](../../agentic/v3-chat-service.md).
