...
| `general-event-bus.md` | **Designed (foundation)** Mill-wide event bus: layered ports, **non-blocking publish**, async dispatch, multicast per-type subscriptions, transport scale path; **WI-311**–**WI-314** |
