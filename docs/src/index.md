...
Mill is a natural language to SQL (NL2SQL) exploration tool that enables users to query structured data using plain English. It supports multiple LLM providers and offers a lightweight, containerized setup for fast experimentation.
