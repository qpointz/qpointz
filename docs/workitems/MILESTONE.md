...
- **AI annotations — entity-scoped agent instructions** (`ai-annotations-facet`, closed **2026-07-07**): [`completed/20260707-ai-annotations-facet/STORY.md`](completed/20260707-ai-annotations-facet/STORY.md). **WI-383**–**WI-388** — platform **`ai-annotation`** facet type (MULTIPLE, `ai` category), Skymill `segments` fixture, **`schema.list_*`** `aiAnnotations[]`, catalog-driven **`metadata-authoring`** agent-instruction capture, **`sql-query`** / **`data-analysis`** prompt honor + Skymill scenario. Design [`docs/design/metadata/ai-annotation-facet-type.md`](../design/metadata/ai-annotation-facet-type.md). Public [`docs/public/src/metadata/mill-ui.md`](../public/src/metadata/mill-ui.md). **BACKLOG** **A-101**, **M-36** `done`.
...
- **Metadata authoring capability and agent profiles** (`metadata-authoring-profiles`, closed **2026-06-29**): [`completed/20260629-metadata-authoring-profiles/STORY.md`](completed/20260629-metadata-authoring-profiles/STORY.md). **WI-354**–**WI-364** — catalog-generic **`metadata-authoring`** (`list_facet_categories` → `propose_facet_assignment`), **`MetadataContent`** seeds, YAML agent profiles, real **`MetadataReadPort`**, multi-artifact batch + SSE, facet lifecycle (**Accept/Reject** via **`mill-events`**), removed **`schema-authoring`** capability, per-capability intent prompts (**WI-363**), mill-ui Mantine 9 (**WI-364**). Design [`docs/design/agentic/metadata-facet-catalog-v3.md`](../design/agentic/metadata-facet-catalog-v3.md), [`docs/design/metadata/metadata-content.md`](../design/metadata/metadata-content.md), [`docs/design/agentic/ai-v3-chat-metadata-scope.md`](../design/agentic/ai-v3-chat-metadata-scope.md). Public [`docs/public/src/mill-ui.md`](../public/src/mill-ui.md). **BACKLOG** **A-98** `done`.

- **Scenario capture and DB export** (`scenario-capture-export`, closed **2026-06-29**): [`completed/20260629-scenario-capture-export/STORY.md`](completed/20260629-scenario-capture-export/STORY.md). **WI-365** — opt-in **`mill.ai.chat.scenario-capture.enabled`** (extended run-event persistence + **`GET /api/v1/ai/chats/{chatId}/scenario-export`**); `ConversationScenarioExporter` + shared `ScenarioPack` types in `mill-ai`; harness typealiases in `mill-ai-test`. Design [`docs/design/agentic/ai-v3-conversation-scenarios.md`](../design/agentic/ai-v3-conversation-scenarios.md) §6, [`docs/design/ai/mill-ai-configuration.md`](../design/ai/mill-ai-configuration.md). Public [`docs/public/src/reference/mill-ai-configuration.md`](../public/src/reference/mill-ai-configuration.md). **BACKLOG** **A-97** `done`.
...
- **WI-383**–**WI-388** — **`ai-annotation`** facet: design contract, platform seed + Skymill `segments` fixture, catalog-driven metadata authoring for agent instructions, `aiAnnotations[]` on **`schema.list_schemas` / `list_tables` / `list_columns`**, **`sql-query`** prompt honor + Skymill scenario; story **`ai-annotations-facet`**, archived [`completed/20260707-ai-annotations-facet/STORY.md`](completed/20260707-ai-annotations-facet/STORY.md). **BACKLOG** **A-101**, **M-36** `done`.
...
- **WI-378** — Model explorer multi-scope read: `?scope=` / `?readScope=` URL state, scope + tag filter pickers, chat deep-links; story **`model-view-multi-scope`**, archived [`completed/20260701-model-view-multi-scope/STORY.md`](completed/20260701-model-view-multi-scope/STORY.md). **BACKLOG** **U-17** `done`.

- **WI-354**–**WI-364** — Metadata authoring profiles: design contract, **`MetadataContent`**, YAML profiles, multi-artifact batch, **`MetadataReadPort`**, catalog-generic facet tools, facet lifecycle events + Accept/Reject REST, remove **`capture_*`**, scenario/e2e + design integration, per-capability intents (**WI-363**), mill-ui Mantine 9 (**WI-364**); story **`metadata-authoring-profiles`**, archived [`completed/20260629-metadata-authoring-profiles/STORY.md`](completed/20260629-metadata-authoring-profiles/STORY.md). **BACKLOG** **A-98** `done`.

- **WI-365** — Scenario capture + DB export: **`mill.ai.chat.scenario-capture.enabled`**, extended routing persistence, **`GET …/scenario-export`**, `ConversationScenarioExporter` / `ScenarioPackYamlWriter`; story **`scenario-capture-export`**, archived [`completed/20260629-scenario-capture-export/STORY.md`](completed/20260629-scenario-capture-export/STORY.md). **BACKLOG** **A-97** `done`.
