...
- [x] WI-089 — Metadata Scopes and Context Composition (`WI-089-metadata-scopes-and-contexts.md`)
- [x] WI-092 — `mill-ui` Model View: Real Backend Binding and Inline Chat Disable (`WI-092-mill-ui-model-view-backend-binding.md`)
