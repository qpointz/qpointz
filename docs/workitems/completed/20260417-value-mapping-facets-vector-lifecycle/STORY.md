...
| E   | **WI-186** | [`WI-186-pgvector-vector-store.md`](WI-186-pgvector-vector-store.md) — optional **`mill.ai.vector-store.backend=pgvector`** (LangChain4j + Postgres **`vector`**) |
...
- Facet-driven RAG scope: [`../../planned/ai-value-mapping-capability/STORY.md`](../../planned/ai-value-mapping-capability/STORY.md) (**WI-157**)
- HTTP + **`mill-ui`** for refresh (follow-up): [`WI-182b-value-mapping-refresh-http-ui.md`](WI-182b-value-mapping-refresh-http-ui.md)
- Metadata bridge / APIs: [`../../planned/metadata-value-mapping/STORY.md`](../../planned/metadata-value-mapping/STORY.md) (**WI-172**, **WI-173**)
...
Archived per [`RULES.md`](../../RULES.md) as **`docs/workitems/completed/20260417-value-mapping-facets-vector-lifecycle/`** (story closure **2026-04-17**).
...
- [x] WI-186 — pgvector `EmbeddingStore` backend (`WI-186-pgvector-vector-store.md`)
