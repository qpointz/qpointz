...
## Completion notes (WI-100)

- Added **`misc/README.md`** and **`misc/cloud/README.md`** describing non–root-build / CI scope.
- Removed or retargeted **dead `misc/rapids/`** paths in **`docs/design/platform/CONFIGURATION_INVENTORY.md`** and **`docs/design/source/flow-kt-design.md`**; refreshed **`mill-jet-*`** sample paths to **`services/mill-data-*`** where applicable.
- **`spring4-migration-plan.md`** Phase 1 checklist updated for this WI.
