...
**Location:** `docs/workitems/completed/20260414-ai-v3-schema-exploration-port/` *(archived 2026-04-14)*
...
- [x] WI-161 — `SchemaCatalogPort` contract in `mill-ai-v3`; remove `mill-data-schema-core` from `mill-ai-v3` (`WI-161-ai-v3-schema-exploration-port-contract.md`)
...
- [x] WI-164 — `mill-ai-v3-autoconfigure`: register `SchemaCatalogPort` bean from `SchemaFacetService` (canonical wiring) (`WI-164-mill-ai-v3-autoconfigure-schema-exploration-port.md`)
