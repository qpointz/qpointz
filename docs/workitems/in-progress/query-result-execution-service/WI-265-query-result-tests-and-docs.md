...
2. Update **[`BACKEND-API-REQUIREMENTS.md`](../../../design/ui/mill-ui/BACKEND-API-REQUIREMENTS.md)** Queries domain: execution sessions at **`POST /api/v1/query`**, **`GET /api/v1/query/{executionId}`**, and **`GET /api/v1/query/{executionId}/rows`** (same path model as **[`STORY.md`](STORY.md)** **Session ownership**, **Paging contract**, **Format negotiation**, **Concurrency**); document **`DELETE /api/v1/query/{executionId}`** as explicit **deallocation**; full envelope + **`data`** + **`epoch`**; **`defaultFormat`** / **`format`** / **`Accept`** / **`400`**/**`406`**/**`409`**; **`PUT` replace**; **delete** normative **`POST /api/v1/queries/execute`** (**breaking** — see **[`GAPS.md`](GAPS.md) §1**).
