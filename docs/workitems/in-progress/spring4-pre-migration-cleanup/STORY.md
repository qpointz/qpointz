...
- [x] WI-097 — gRPC catalog and reference-tree hygiene (`WI-097-grpc-catalog-and-misc-reference-hygiene.md`)
- [x] WI-098 — Jakarta naming and `javax.annotation` catalog (`WI-098-jakarta-and-annotation-api-catalog.md`)
- [x] WI-099 — Security test coordinate alignment (`WI-099-spring-security-test-bom-alignment.md`)
- [x] WI-100 — `misc/` non-product trees: catalogs and stale paths (`WI-100-misc-rapids-and-spring3-catalogs.md`)
- [x] WI-101 — SpringDoc / OpenAPI version consistency (`WI-101-springdoc-catalog-audit.md`)
- [x] WI-102 — `META-INF` auto-configuration legacy audit (`WI-102-spring-factories-and-auto-config-imports.md`)
- [x] WI-103 — Boot 4 jump-start inventory (grep-only checklist) (`WI-103-boot4-jump-start-inventory.md`)
- [x] WI-104 — Refresh `spring4-migration-plan.md` Phase 1 status (`WI-104-update-spring4-migration-plan-phase1.md`)
