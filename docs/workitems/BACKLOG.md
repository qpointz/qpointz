...
| P-38 | Mill application event bus foundation: `mill-events` contracts, transport plane, dynamic Spring `EventConsumer` wiring (**WI-311**–**WI-314**) | ✨ feature | done | [`in-progress/general-event-bus/STORY.md`](in-progress/general-event-bus/STORY.md) · [cold start](in-progress/general-event-bus/COLDSTART.md) |
