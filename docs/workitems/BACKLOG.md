...
| M-33 | **Flow backend inferred facets** — `FlowDescriptorMetadataSource`, `platform-flow-facet-types.yaml`, **`flow-*`** facet types + mill-ui Flow tab / generic OBJECT display; autoconfigure + `testIT` | ✨ feature | done | `completed/20260402-flow-source-ui-facets/STORY.md`, `design/metadata/backend-provided-metadata.md` |
