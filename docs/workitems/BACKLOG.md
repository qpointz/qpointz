...
| P-38 | Mill application event bus foundation: `mill-events` contracts, transport plane, dynamic Spring `EventConsumer` wiring (**WI-311**–**WI-314**) | ✨ feature | planned | [`planned/general-event-bus/STORY.md`](planned/general-event-bus/STORY.md) · [cold start](planned/general-event-bus/COLDSTART.md) |
