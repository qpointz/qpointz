...
| P-7  | Migrate Jackson 2.x to Jackson 3.0 (ObjectMapper->JsonMapper, package changes)                                                                                                           | 🔧 refactoring | done    | [`in-progress/spring4-migration-day-2/WI-205-jackson-3-migration.md`](in-progress/spring4-migration-day-2/WI-205-jackson-3-migration.md), platform/spring4-migration-plan.md |
