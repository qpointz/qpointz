...
object SurfaceService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The surface service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the SurfaceService.
  */
trait SurfaceService extends Service {
  ...
  override final def descriptor: Descriptor = {
    ...
    named("surface")
      ...
      .withTopics(
        topic(SurfaceService.TOPIC_NAME, greetingsTopic _)
