...
class DeltaServiceMetadataTest extends DeltaServiceBaseTest {


    @Test
    void handshakeTest(@Autowired DeltaServiceGrpc.DeltaServiceBlockingStub stub) {
    ...
    @Test
    void listSchemas(@Autowired DeltaServiceGrpc.DeltaServiceBlockingStub stub,
    ...
    @Test
    void getMissingSchema(@Autowired DeltaServiceGrpc.DeltaServiceBlockingStub stub,
                          @Autowired MetadataProvider metadataProvider) {
    ...
    @Test
    void getSchema(@Autowired DeltaServiceGrpc.DeltaServiceBlockingStub stub,
                   @Autowired MetadataProvider metadataProvider) {
