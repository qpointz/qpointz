...
public class RapidsParquetSchemaFactory implements SchemaFactory {
    ...
    public static final String AZ_STORAGE_ACCOUNT_NAME = "az.storage.account.name";
    public static final String AZ_STORAGE_ACCOUNT_KEY = "az.storage.account.key";
    public static final String AZ_STORAGE_CONTAINERS = "az.storage.container";
    private static final String MISSING_S_PARAMETER = "Missing '%s' parameter";
    public static final String DIR_KEY = "rootDir";

    public static final String CACHE_EXPIRES_AFTER = "cache.expiresAfter";

    public static final String RX_DATASET_GROUP_KEY = "rx.datasetGroup";

    public static final String RX_PATTERN_KEY = "rx.pattern";
