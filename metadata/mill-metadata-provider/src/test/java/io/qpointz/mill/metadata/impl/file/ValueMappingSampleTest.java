package io.qpointz.mill.metadata.impl.file;
...
class ValueMappingSampleTest {
    ...
    private FileAnnotationsRepository loadRepository() throws IOException {
        try (var stream = ValueMappingSampleTest.class.getClassLoader().getResourceAsStream("metadata/value-mapping-sample.yml")) {
