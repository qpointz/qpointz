...
public class FlowDescriptorMetadataSourceAutoConfiguration {
     ...
     * @param backendMetadataProperties global metadata hygiene (including {@code redact})
    ...
    public FlowDescriptorMetadataSource flowDescriptorMetadataSource(
            ...
            BackendMetadataProperties backendMetadataProperties) {
        ...
        return new FlowDescriptorMetadataSource(
                ...
                ttl,
                backendMetadataProperties.getRedact());
    }
}
